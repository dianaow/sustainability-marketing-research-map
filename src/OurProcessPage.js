    ...
    <React.Fragment>
      ...
      <div className="App__wrapper">
        <div className='App_container-textonly'>
          <h1>Our Process</h1>
          <p>There were several methodological steps involved in developing the A-VO-S Map. First, we had to identify the dimensions that made up the theoretical framework of the A-VO-S Map. After that, we had to develop a codebook to conduct the content analysis to map the empirical articles onto the A-VO-S Map. Below, you can see a summarized explanation of how these steps were completed. </p>
          
          <b>Framework Development – A Meta-Review of Sustainability Marketing</b>
          <p>We utilized the meta-review methodology to develop the A-VO-S framework. The goal of this method is to synthesize, combine, and interpret research with a meta-theoretical approach rather than focusing on individual primary effects (Breslin & Gatrell, 2020; Hallinger, 2021; Paré et al., 2015; Saeri et al., 2022). Hence, for this step, we only focused on conceptual sustainability marketing articles, and not empirical articles, as we were aiming to develop theoretical unity rather than effect-based understanding.</p>
          <p>Our sample was collected using the search terms “sustainab*” and “marketing” in Web of Science and Scopus, generating over 10,000 articles that were distilled down to 43 seminal conceptual articles in sustainability marketing. Then, using qualitative directed content analysis and the Atlas.ti software, we these articles along emergent code groups. From this process, we found the themes of Actors, Value Orientations and Scope of Sustainability that encapsulated the theoretical offerings of these articles. For the full methodological process, please refer to the manuscript.</p>

          <b>A-VO-S Map – Codebook Development & Mapping Empirical Articles </b>
          ...
          <p>To do this, we first had to develop a codebook. This step was aided by the prior identification of the A-VO-S dimensions through conceptual work. Hence, although this was a reiterative process to reach the optimum level of reliability of our codebook across coders, the foundation of the codebook had already been built. Our coders were trained for eight hours and conducted a pilot and second pilot test phase, reaching high Krippendorf reliability levels. All articles were then coded based on the final version of the codebook, and the pilot articles were recoded to preserve the sample size. Following this coding process, the results were handed over to the web developer to build the A-VO-S Map that you see here.</p>
